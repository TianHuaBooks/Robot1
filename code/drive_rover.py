...
class RoverState():
    ...
    def has_rock_been_collected(self, rock_x, rock_y):
        ...
        if self.samples_collected > 0:
            print("rock_x:", rock_x, " rock_y:", rock_y)
            print("rock_collected:", self.rock_collected)
        result = False
        for rock in self.rock_collected:
            if abs(rock[0] - rock_x) < 0.5 and abs(rock[1] - rock_y) < 0.5:
                result = True
                break
        return result
